  ...
  $gambar = $angka_acak.'-'.$gambar; //menggabungkan angka acak dengan nama file sebenarnya
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {     
                move_uploaded_file($file_tmp, 'gambar/'.$gambar); //memindah file gambar ke folder gambar
                  ...
                  $query = "INSERT INTO produk (nama_produk, deskripsi, harga, gambar, stok) VALUES ('$nama_produk', '$deskripsi', '$harga', '$gambar', '$stok')";
   ...
   $query = "INSERT INTO produk (nama_produk, deskripsi, harga, gambar, stok) VALUES ('$nama_produk', '$deskripsi', '$harga', '$stok', null)";
                  $result = mysqli_query($koneksi, $query);
                  // periska query apakah ada error
                  if(!$result){
                      die ("Query gagal dijalankan: ".mysqli_errno($koneksi).
